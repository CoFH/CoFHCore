...
//
//        gen.addProvider(event.includeClient(), new CoreBlockStateProvider(pOutput, exFileHelper));
//        gen.addProvider(event.includeClient(), new CoreItemModelProvider(pOutput, exFileHelper));
//    }
//
//}
