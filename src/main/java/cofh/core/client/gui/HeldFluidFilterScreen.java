...
public class HeldFluidFilterScreen extends ContainerScreenCoFH<HeldFluidFilterContainer> {
    ...
    public HeldFluidFilterScreen(HeldFluidFilterContainer container, Inventory inv, Component titleIn) {
