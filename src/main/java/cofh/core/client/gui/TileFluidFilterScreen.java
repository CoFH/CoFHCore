...
public class TileFluidFilterScreen extends ContainerScreenCoFH<TileFluidFilterContainer> {
    ...
    protected List<ElementFluid> displayFluids = new ArrayList<>();

    public TileFluidFilterScreen(TileFluidFilterContainer container, Inventory inv, Component titleIn) {
