...
public class CoreRecipeSerializers {
    ...
    public static final RegistryObject<RecipeSerializer<SecureRecipe>> SECURE_RECIPE_SERIALIZER = RECIPE_SERIALIZERS.register(ID_CRAFTING_SECURABLE, () -> new SimpleRecipeSerializer<>(SecureRecipe::new));
