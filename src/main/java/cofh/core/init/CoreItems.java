...
import cofh.lib.content.item.DyeableHorseArmorItemCoFH;
import cofh.lib.content.item.HorseArmorItemCoFH;
import cofh.lib.content.item.ShearsItemCoFH;
import cofh.lib.content.item.ShieldItemCoFH;
