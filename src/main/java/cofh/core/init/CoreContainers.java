...
public class CoreContainers {
    ...
    public static void register() {
        ...
        CONTAINERS.register(ID_CONTAINER_HELD_INVENTORY, () -> IForgeContainerType.create((windowId, inv, data) -> new HeldInventoryContainer(windowId, inv, ProxyUtils.getClientPlayer())));
