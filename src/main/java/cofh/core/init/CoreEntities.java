...
public class CoreEntities {
    ...
    public static void register() {
        ...
        ENTITIES.register(ID_ELECTRIC_ARC, () -> EntityType.Builder.<ElectricArcEntity>of(ElectricArcEntity::new, EntityClassification.MISC).sized(0.2F, 10.0F).fireImmune().build(ID_ELECTRIC_ARC));
    }
