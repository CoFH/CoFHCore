...
public class CoreEntities {
    ...
    public static final RegistryObject<EntityType<FrostField>> FROST_FIELD = ENTITIES.register(ID_FROST_FIELD, () -> EntityType.Builder.<FrostField>of(FrostField::new, MobCategory.MISC).sized(0.1F, 0.1F).fireImmune().noSave().build(ID_FROST_FIELD));
