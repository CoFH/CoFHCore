...
public class ItemTagsCoFH {
    ...
    public static final IOptionalNamedTag<Item> COINS = forgeTag("coins");

    public static final IOptionalNamedTag<Item> COINS_BRONZE = forgeTag("coins/bronze");
    public static final IOptionalNamedTag<Item> COINS_CONSTANTAN = forgeTag("coins/constantan");
    public static final IOptionalNamedTag<Item> COINS_COPPER = forgeTag("coins/copper");
    public static final IOptionalNamedTag<Item> COINS_ELECTRUM = forgeTag("coins/electrum");
    public static final IOptionalNamedTag<Item> COINS_ENDERIUM = forgeTag("coins/enderium");
    public static final IOptionalNamedTag<Item> COINS_GOLD = forgeTag("coins/gold");
    public static final IOptionalNamedTag<Item> COINS_INVAR = forgeTag("coins/invar");
    ...
    public static final IOptionalNamedTag<Item> CROPS_PEANUT = forgeTag("crops/peanut");
    public static final IOptionalNamedTag<Item> CROPS_RADISH = forgeTag("crops/radish");
    public static final IOptionalNamedTag<Item> CROPS_RICE = forgeTag("crops/rice");
    public static final IOptionalNamedTag<Item> CROPS_SADIROOT = forgeTag("crops/sadiroot");
    public static final IOptionalNamedTag<Item> CROPS_SPINACH = forgeTag("crops/spinach");
    public static final IOptionalNamedTag<Item> CROPS_STRAWBERRY = forgeTag("crops/strawberry");
    public static final IOptionalNamedTag<Item> CROPS_TEA = forgeTag("crops/tea");
    public static final IOptionalNamedTag<Item> CROPS_TOMATO = forgeTag("crops/tomato");

    public static final IOptionalNamedTag<Item> DUSTS_APATITE = forgeTag("dusts/apatite");
    public static final IOptionalNamedTag<Item> DUSTS_BRONZE = forgeTag("dusts/bronze");
    public static final IOptionalNamedTag<Item> DUSTS_CINNABAR = forgeTag("dusts/cinnabar");
    public static final IOptionalNamedTag<Item> DUSTS_CONSTANTAN = forgeTag("dusts/constantan");
    public static final IOptionalNamedTag<Item> DUSTS_COPPER = forgeTag("dusts/copper");
    public static final IOptionalNamedTag<Item> DUSTS_DIAMOND = forgeTag("dusts/diamond");
    public static final IOptionalNamedTag<Item> DUSTS_ELECTRUM = forgeTag("dusts/electrum");
    public static final IOptionalNamedTag<Item> DUSTS_EMERALD = forgeTag("dusts/emerald");
    public static final IOptionalNamedTag<Item> DUSTS_ENDER_PEARL = forgeTag("dusts/ender_pearl");
    public static final IOptionalNamedTag<Item> DUSTS_ENDERIUM = forgeTag("dusts/enderium");
    ...
    public static final IOptionalNamedTag<Item> DUSTS_SIGNALUM = forgeTag("dusts/signalum");
    ...
    public static final IOptionalNamedTag<Item> GEARS_BRONZE = forgeTag("gears/bronze");
    public static final IOptionalNamedTag<Item> GEARS_CONSTANTAN = forgeTag("gears/constantan");
    public static final IOptionalNamedTag<Item> GEARS_COPPER = forgeTag("gears/copper");
    public static final IOptionalNamedTag<Item> GEARS_DIAMOND = forgeTag("gears/diamond");
    public static final IOptionalNamedTag<Item> GEARS_ELECTRUM = forgeTag("gears/electrum");
    public static final IOptionalNamedTag<Item> GEARS_EMERALD = forgeTag("gears/emerald");
    public static final IOptionalNamedTag<Item> GEARS_ENDERIUM = forgeTag("gears/enderium");
    public static final IOptionalNamedTag<Item> GEARS_GOLD = forgeTag("gears/gold");
    public static final IOptionalNamedTag<Item> GEARS_INVAR = forgeTag("gears/invar");
    public static final IOptionalNamedTag<Item> GEARS_IRON = forgeTag("gears/iron");
    ...
    public static final IOptionalNamedTag<Item> GEARS_SAPPHIRE = forgeTag("gears/sapphire");
    public static final IOptionalNamedTag<Item> GEARS_SIGNALUM = forgeTag("gears/signalum");
    public static final IOptionalNamedTag<Item> GEARS_SILVER = forgeTag("gears/silver");
    public static final IOptionalNamedTag<Item> GEARS_TIN = forgeTag("gears/tin");

    public static final IOptionalNamedTag<Item> GEMS_APATITE = forgeTag("gems/apatite");
    public static final IOptionalNamedTag<Item> GEMS_CINNABAR = forgeTag("gems/cinnabar");
    public static final IOptionalNamedTag<Item> GEMS_NITER = forgeTag("gems/niter");
    ...
    public static final IOptionalNamedTag<Item> GEMS_SULFUR = forgeTag("gems/sulfur");

    public static final IOptionalNamedTag<Item> INGOTS_BRONZE = forgeTag("ingots/bronze");
    public static final IOptionalNamedTag<Item> INGOTS_CONSTANTAN = forgeTag("ingots/constantan");
    ...
    public static final IOptionalNamedTag<Item> INGOTS_ENDERIUM = forgeTag("ingots/enderium");
    ...
    public static final IOptionalNamedTag<Item> INGOTS_LUMIUM = forgeTag("ingots/lumium");
    public static final IOptionalNamedTag<Item> INGOTS_NICKEL = forgeTag("ingots/nickel");
    public static final IOptionalNamedTag<Item> INGOTS_SIGNALUM = forgeTag("ingots/signalum");
    ...
    // public static final IOptionalNamedTag<Item> NUGGETS_DIAMOND = forgeTag("nuggets/diamond");
    public static final IOptionalNamedTag<Item> NUGGETS_ELECTRUM = forgeTag("nuggets/electrum");
    // public static final IOptionalNamedTag<Item> NUGGETS_EMERALD = forgeTag("nuggets/emerald");
    public static final IOptionalNamedTag<Item> NUGGETS_ENDERIUM = forgeTag("nuggets/enderium");
    ...
    public static final IOptionalNamedTag<Item> NUGGETS_SIGNALUM = forgeTag("nuggets/signalum");
    ...
    public static final IOptionalNamedTag<Item> ORES_APATITE = forgeTag("ores/apatite");
    public static final IOptionalNamedTag<Item> ORES_CINNABAR = forgeTag("ores/cinnabar");
    ...
    public static final IOptionalNamedTag<Item> ORES_NITER = forgeTag("ores/niter");
    ...
    public static final IOptionalNamedTag<Item> ORES_SULFUR = forgeTag("ores/sulfur");
    ...
    public static final IOptionalNamedTag<Item> PLATES_BRONZE = forgeTag("plates/bronze");
    public static final IOptionalNamedTag<Item> PLATES_CONSTANTAN = forgeTag("plates/constantan");
    public static final IOptionalNamedTag<Item> PLATES_COPPER = forgeTag("plates/copper");
    // public static final IOptionalNamedTag<Item> PLATES_DIAMOND = forgeTag("plates/diamond");
    public static final IOptionalNamedTag<Item> PLATES_ELECTRUM = forgeTag("plates/electrum");
    // public static final IOptionalNamedTag<Item> PLATES_EMERALD = forgeTag("plates/emerald");
    public static final IOptionalNamedTag<Item> PLATES_ENDERIUM = forgeTag("plates/enderium");
    public static final IOptionalNamedTag<Item> PLATES_GOLD = forgeTag("plates/gold");
    public static final IOptionalNamedTag<Item> PLATES_INVAR = forgeTag("plates/invar");
    public static final IOptionalNamedTag<Item> PLATES_IRON = forgeTag("plates/iron");
    ...
    // public static final IOptionalNamedTag<Item> PLATES_SAPPHIRE = forgeTag("plates/sapphire");
    public static final IOptionalNamedTag<Item> PLATES_SIGNALUM = forgeTag("plates/signalum");
    ...
    public static final IOptionalNamedTag<Item> SEEDS_PEANUT = forgeTag("seeds/peanut");
    public static final IOptionalNamedTag<Item> SEEDS_RADISH = forgeTag("seeds/radish");
    public static final IOptionalNamedTag<Item> SEEDS_RICE = forgeTag("seeds/rice");
    public static final IOptionalNamedTag<Item> SEEDS_SADIROOT = forgeTag("seeds/sadiroot");
    public static final IOptionalNamedTag<Item> SEEDS_SPINACH = forgeTag("seeds/spinach");
    public static final IOptionalNamedTag<Item> SEEDS_STRAWBERRY = forgeTag("seeds/strawberry");
    public static final IOptionalNamedTag<Item> SEEDS_TEA = forgeTag("seeds/tea");
    public static final IOptionalNamedTag<Item> SEEDS_TOMATO = forgeTag("seeds/tomato");
    ...
    public static final IOptionalNamedTag<Item> STORAGE_BLOCKS_COAL_COKE = forgeTag("storage_blocks/coal_coke");
    public static final IOptionalNamedTag<Item> STORAGE_BLOCKS_CONSTANTAN = forgeTag("storage_blocks/constantan");
    ...
    public static final IOptionalNamedTag<Item> STORAGE_BLOCKS_NITER = forgeTag("storage_blocks/niter");
    ...
    public static final IOptionalNamedTag<Item> COLORABLE = thermalTag("crafting/colorable");
    ...
    public static final IOptionalNamedTag<Item> HARDENED_GLASS = thermalTag("glass/hardened");
    public static final IOptionalNamedTag<Item> ROCKWOOL = thermalTag("rockwool");

    // region HELPERS
    private static IOptionalNamedTag<Item> thermalTag(String name) {
