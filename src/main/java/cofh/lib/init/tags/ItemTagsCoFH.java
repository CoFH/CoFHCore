...
public class ItemTagsCoFH {
    ...
    public static final TagKey<Item> COINS_ALUMINUM = forgeTag("coins/aluminum");
    ...
    public static final TagKey<Item> COINS_URANIUM = forgeTag("coins/uranium");
    ...
    public static final TagKey<Item> GEARS_URANIUM = forgeTag("gears/uranium");
    ...
    public static final TagKey<Item> PLATES_URANIUM = forgeTag("plates/uranium");
    ...
    public static final TagKey<Item> STORAGE_BLOCKS_RAW_URANIUM = forgeTag("storage_blocks/raw_uranium");
    ...
    public static final TagKey<Item> STORAGE_BLOCKS_URANIUM = forgeTag("storage_blocks/uranium");
